...
public class GameIOSIndex {
	public String index_path;
	public String pid_path;
	public String log_path;
	
	public GameIOSIndex(String index_path,String pid_path,String log_path){
	...
	public void addDocument(IndexWriter writer,Game game)
	{
		try {
	         ...
	         // doc.add(new StringField("bundle_id", game.bundle_id, Field.Store.YES));
	          ...
	          doc.add(new StringField("publisher_name", String.valueOf(game.publisher_name), Field.Store.YES));
	          doc.add(new StringField("version_ios", String.valueOf(game.version_ios), Field.Store.YES));
	          doc.add(new StringField("version_os_ios", String.valueOf(game.version_os_ios), Field.Store.YES));
	          doc.add(new StringField("size_ios", String.valueOf(game.size_ios), Field.Store.YES));
	          
	          doc.add(new StringField("count_ios_download", String.valueOf(game.count_ios_download), Field.Store.YES));
	          doc.add(new StringField("count_ios_view", String.valueOf(game.count_ios_view), Field.Store.YES));
	          ...
	          doc.add(new StringField("file_ipa", String.valueOf(game.file_ipa), Field.Store.YES));
	          doc.add(new StringField("file_plist", String.valueOf(game.file_plist), Field.Store.YES));
		...
		try {
		    ...
		    IndexWriterConfig iwc = new IndexWriterConfig(Version.LUCENE_4_9, analyzer);
		     ...
		     while(true){
		    	 	...
		    	 	java.util.List<Game> games = gameStoreDAO.getGameIOS(update_date);
	...
	public static void main(String[] args) {
		/*String log_path = "C:/Projects/index/gameIos/log/logIndexIOS.txt";
		String pid_Path = "C:/Projects/index/gameIos/log/pidIndexIOS.txt";
		
		GameIOSIndex  gameIndex = new GameIOSIndex("C:\\Projects\\index\\gameIos\\", pid_Path,log_path);
		gameIndex.indexGame();*/
		
		String log_path = "/home/search/gameIOS/log/logIndexIOS.txt";
		String pid_Path = "/home/search/gameIOS/log/pidIndexIOS.txt";
		
		GameIOSIndex  gameIndex = new GameIOSIndex("/home/search/gameIOS/", pid_Path,log_path);
		gameIndex.indexGame();
	}
}
