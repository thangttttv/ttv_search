...
public class KKTPool {
	...
	private static DataSource setupDataSource() {
		try {
			...
			System.out.println(DBConfig.db_audio_driver_Service);
			Class.forName("com.mysql.jdbc.Driver");
			unpooled = DataSources
			.unpooledDataSource(DBConfig.db_audio_url_Service,
					DBConfig.db_audio_user_Service,DBConfig.db_audio_pass_Service);
